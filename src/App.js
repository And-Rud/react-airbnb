...
import Comfortable from "./component/comfortable";
import Contact from "./component/contact";
import Add from "./component/add";
import Reviews from "./component/reviews";
import Attract from "./component/attract";
...
function App() {
  ...
  return (
    <Page>
      ...
      />
      <Foto src={data.image} name={data.listing_name} />
      <Price
      ...
      />
      <RoomList room={data.roomTypes} />
      <Description title="Опис" description={data.description} />
      <Property
      ...
      />
      <Description title="Про сусідів" description={data.neighborhood_info} />
      <Comfortable
        title="Зручності"
      ...
      />
      <Reviews rev={data.guestReviews} />
      <Attract att={data.nearbyAttractions} />
    </Page>
  );
}
